...
//			kunden = ks.findAllKunden(FetchType.MIT_BESTELLUNGEN, FetchType.NUR_KUNDE);
...
//		this.kunde = ks.findKundebyID(ausgewaehlterKunde.getKId(), FetchType.MIT_BESTELLUNGEN, locale);
//		this.kundeId = this.kunde.getKId();
//		
//		return JSF_VIEW_KUNDE;
//	}
//	
...
//
//		try {
//			neuerKunde = (Kunde) ks.createKunde(neuerKunde);
//		}
...
//			final Set<HobbyType> hobbiesKunde = privatkunde.getHobbies();
//			hobbiesKunde.clear();
//			
